...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://nemu02.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        }
    ...
    deleteImage(imageType) {
        ...
        .then(response => {
            this.props.handleFeauturedImageDelete()
        })
        .catch(error => {
    ...
    componentWillMount() {
        ...
        this.setState({
            ...
            apiUrl: `https://nemu02.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
            apiAction: "patch"
        }); 
        }
    }
