...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo: '',
            editMode: false,
            apiUrl: 'https://nemu02.devcamp.space/portfolio/portfolio_items',
            apiAction: 'post'
        };
    ...
    componentDidUpdate () {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://nemu02.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: 'patch',
            ...
            <form className="portfolio-form-wrapper" onSubmit={this.handleSubmit}>
                ...
                <div className="two-column">
                    ...
                    >
                        ...
                        <option value="FirstGen">First Generation Pokemon</option>
                        <option value="SecondGen">Second Generation Pokemon</option>
                        <option value="Trainer">Pokemon Trainer</option>
